...
{
    public partial class Final1700251 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 6, 55, new DateTime(2022, 4, 21, 2, 14, 21, 696, DateTimeKind.Local).AddTicks(8507), 1, false, true, "MAN" },
                    { 2, 10, 55, new DateTime(2022, 4, 21, 2, 14, 21, 699, DateTimeKind.Local).AddTicks(3424), 2, false, true, "Volvo" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 4, 21, 2, 14, 21, 701, DateTimeKind.Local).AddTicks(245), 1, 1 },
                    { 2, new DateTime(2022, 4, 21, 2, 14, 21, 701, DateTimeKind.Local).AddTicks(902), 2, 2 },
                    { 3, new DateTime(2022, 4, 21, 2, 14, 21, 701, DateTimeKind.Local).AddTicks(932), 3, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 4, 21, 10, 14, 21, 699, DateTimeKind.Local).AddTicks(5289), new DateTime(2022, 4, 21, 2, 14, 21, 699, DateTimeKind.Local).AddTicks(4988), 1, 1 },
                    { 2, 2, new DateTime(2022, 4, 21, 10, 14, 21, 699, DateTimeKind.Local).AddTicks(5923), new DateTime(2022, 4, 21, 2, 14, 21, 699, DateTimeKind.Local).AddTicks(5912), 1, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTime(2022, 4, 21, 2, 14, 21, 701, DateTimeKind.Local).AddTicks(7723), new DateTime(2022, 4, 21, 14, 14, 21, 701, DateTimeKind.Local).AddTicks(7995), 1, 1, true, "U jednom pravcu" },
                    { 2, true, new DateTime(2022, 4, 21, 2, 14, 21, 701, DateTimeKind.Local).AddTicks(9060), new DateTime(2022, 5, 21, 2, 14, 21, 701, DateTimeKind.Local).AddTicks(9071), 2, 2, true, "U oba pravca" }
                });

            migrationBuilder.InsertData(
                table: "PlatiKartu",
                columns: new[] { "PlatiKartuID", "Cijena", "DatumVadjenjaKarte", "DatumVazenjaKarte", "JeLiPlacena", "KartaID", "KupacID" },
                values: new object[] { 1, 10.0, new DateTime(2022, 4, 21, 2, 14, 21, 702, DateTimeKind.Local).AddTicks(435), new DateTime(2022, 5, 21, 2, 14, 21, 702, DateTimeKind.Local).AddTicks(690), true, 2, 2 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 6, new DateTime(2022, 4, 21, 2, 14, 21, 702, DateTimeKind.Local).AddTicks(2025), 5m, false, 1, 2, 1, 1, new DateTime(2022, 4, 21, 2, 14, 21, 702, DateTimeKind.Local).AddTicks(3935), new DateTime(2022, 4, 21, 2, 14, 21, 702, DateTimeKind.Local).AddTicks(3694) },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 4, 21, 2, 14, 21, 702, DateTimeKind.Local).AddTicks(5372), "Sve pohvale!", 1, 5, 1, "Osoblje" });

            migrationBuilder.InsertData(
                table: "Recenzija",
                columns: new[] { "RecenzijaID", "DatumRecenzije", "Komentar", "KupacID", "Ocjena", "RasporedVoznjeID", "VrstaUsluga" },
                values: new object[] { 2, new DateTime(2022, 4, 21, 2, 14, 21, 702, DateTimeKind.Local).AddTicks(6677), "Nije očišćeno!", 2, 3, 2, "Vozilo" });
        }
