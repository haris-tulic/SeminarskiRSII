    ...
    public partial class Final : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 6, 55, new DateTime(2022, 4, 21, 2, 1, 23, 750, DateTimeKind.Local).AddTicks(8082), 1, false, true, "MAN" },
                    { 2, 10, 55, new DateTime(2022, 4, 21, 2, 1, 23, 753, DateTimeKind.Local).AddTicks(7402), 2, false, true, "Volvo" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2022, 4, 21, 2, 1, 23, 755, DateTimeKind.Local).AddTicks(6669), 1, 1 },
                    { 2, new DateTime(2022, 4, 21, 2, 1, 23, 755, DateTimeKind.Local).AddTicks(7332), 2, 2 },
                    { 3, new DateTime(2022, 4, 21, 2, 1, 23, 755, DateTimeKind.Local).AddTicks(7363), 3, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 4, 21, 10, 1, 23, 753, DateTimeKind.Local).AddTicks(9460), new DateTime(2022, 4, 21, 2, 1, 23, 753, DateTimeKind.Local).AddTicks(9148), 1, 1 },
                    { 2, 2, new DateTime(2022, 4, 21, 10, 1, 23, 754, DateTimeKind.Local).AddTicks(19), new DateTime(2022, 4, 21, 2, 1, 23, 754, DateTimeKind.Local).AddTicks(8), 1, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, new DateTime(2022, 4, 21, 2, 1, 23, 756, DateTimeKind.Local).AddTicks(4282), new DateTime(2022, 4, 21, 14, 1, 23, 756, DateTimeKind.Local).AddTicks(4564), 1, 1, true, "U jednom pravcu" },
                    { 2, true, new DateTime(2022, 4, 21, 2, 1, 23, 756, DateTimeKind.Local).AddTicks(6052), new DateTime(2022, 5, 21, 2, 1, 23, 756, DateTimeKind.Local).AddTicks(6063), 2, 2, true, "U oba pravca" }
                });

            migrationBuilder.InsertData(
                table: "PlatiKartu",
                columns: new[] { "PlatiKartuID", "Cijena", "DatumVadjenjaKarte", "DatumVazenjaKarte", "JeLiPlacena", "KartaID", "KupacID" },
                values: new object[] { 1, 10.0, new DateTime(2022, 4, 21, 2, 1, 23, 756, DateTimeKind.Local).AddTicks(7490), new DateTime(2022, 5, 21, 2, 1, 23, 756, DateTimeKind.Local).AddTicks(7755), true, 2, 2 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 6, new DateTime(2022, 4, 21, 2, 1, 23, 756, DateTimeKind.Local).AddTicks(9172), 5m, false, 1, 2, 1, 1, new DateTime(2022, 4, 21, 2, 1, 23, 757, DateTimeKind.Local).AddTicks(1131), new DateTime(2022, 4, 21, 2, 1, 23, 757, DateTimeKind.Local).AddTicks(883) },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 4, 21, 2, 1, 23, 757, DateTimeKind.Local).AddTicks(2615), "Sve pohvale!", 1, 5, 1, "Osoblje" });

            migrationBuilder.InsertData(
                table: "Recenzija",
                columns: new[] { "RecenzijaID", "DatumRecenzije", "Komentar", "KupacID", "Ocjena", "RasporedVoznjeID", "VrstaUsluga" },
                values: new object[] { 2, new DateTime(2022, 4, 21, 2, 1, 23, 757, DateTimeKind.Local).AddTicks(3744), "Nije očišćeno!", 2, 3, 2, "Vozilo" });
        }
    }
}
